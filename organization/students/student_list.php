...
<head>
    ...
    <title>Students - Organization Panel</title>
...
<body>
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="d-flex gap-2 align-items-end">
                                    <button class="btn btn-primary" id="addStudentBtn" style="white-space: nowrap; flex: 1; min-width: 0; height: 42px; display: inline-flex; align-items: center; justify-content: center;">
                            ...
                            <table class="admin-table">
                                ...
                                <tbody id="studentTableBody">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p style="margin: 0; font-size: 0.85rem; color: var(--text-secondary);">#STU004</p>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="sidebar-user-avatar" style="width: 32px; height: 32px; font-size: 0.85rem;">EM</div>
                                                <div>
                                                    <h6 style="margin: 0; color: var(--text-primary);">Emma Miller</h6>
                                                    <p style="margin: 0; font-size: 0.85rem; color: var(--text-secondary);">#STU005</p>
                                                </div>
                                            </div>
                                        </td>
    ...
    <script>
        ...
        function updateStudentCount() {
            const visibleRows = Array.from(studentTableBody.getElementsByTagName('tr')).filter(row => row.style.display !== 'none');
            const studentCount = document.getElementById('studentCount');
            if (studentCount) {
                studentCount.textContent = `${visibleRows.length} Students`;
            }
        }
        ...
        document.querySelectorAll('.action-btn.delete').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                const studentName = row.querySelector('h6')?.textContent || 'this student';
                
                if (confirm(`Are you sure you want to delete ${studentName}? This will also affect all associated examination results. This action cannot be undone.`)) {
                    deleteStudent(studentId);
                }
            });
        });

        // Delete Student Function (Backend Ready)
        async function deleteStudent(studentId) {
            try {
                // TODO: Replace with actual API endpoint when backend is ready
                // const response = await fetch(`../../api/organization/students/delete.php`, {
                //     method: 'POST',
