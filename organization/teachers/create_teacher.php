...
<head>
    ...
    <title>Add Teacher - Organization Panel</title>
    ...
    <div class="admin-wrapper">
        <aside class="admin-sidebar" id="orgSidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <ul class="list-unstyled">
                    <li class="nav-item"><a href="teacher_list.php" class="nav-link active"><i class="bi bi-people"></i><span>Teachers</span></a></li>
        ...
        <main class="admin-main">
            ...
            <div class="admin-topbar">
                <div class="topbar-left">
                    <div>
                        <h1 class="topbar-title">Add Teacher</h1>
                    ...
                    <div class="content-card-body">
                        <form id="createTeacherForm">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="admin-form-group">
                                        <label class="admin-form-label">Full Name <span class="required-asterisk">*</span></label>
                                        <input type="text" class="admin-form-control" id="teacherName" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="admin-form-group">
                                        <label class="admin-form-label">Email <span class="required-asterisk">*</span></label>
                                        <input type="email" class="admin-form-control" id="teacherEmail" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="admin-form-group">
                                        <label class="admin-form-label">Phone Number</label>
                                        <input type="tel" class="admin-form-control" id="teacherPhone">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="admin-form-group">
                                        <label class="admin-form-label">Status <span class="required-asterisk">*</span></label>
                                        <select class="admin-form-control" id="teacherStatus" required>
                            ...
                            <div class="d-flex gap-2 mt-3">
                                ...
                                <a href="teacher_list.php" class="btn btn-outline-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
