...
<head>
    ...
    <title>Preview Examination - Teacher Panel</title>
        ...
        <main class="admin-main">
            ...
            <div class="admin-topbar">
                <div class="topbar-left">
                    <div>
                        <h1 class="topbar-title">Preview Examination</h1>
            ...
            <div class="admin-content">
                <div class="content-card">
                    <div class="content-card-header">
                        <h2 class="content-card-title">Data Structures Midterm</h2>
                        <div class="d-flex gap-2">
                            <a href="upload_quiz.php?id=1&edit=1" class="btn btn-primary"><i class="bi bi-pencil"></i> Edit</a>
                            <a href="quiz_list.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Back</a>
                        </div>
                    </div>
                    <div class="content-card-body">
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <p><strong>Examination Code:</strong> MATH-FIN-2024</p>
                                <p><strong>Type:</strong> <span class="badge badge-info">Objective</span></p>
                        ...
                        <hr>
                        <h4 class="mb-3">Examination Questions</h4>
                        <div class="question-preview">
                            <div class="mb-4 p-3" style="background: var(--bg-secondary); border-radius: 8px;">
                                <h5>Question 1</h5>
                                <p>What is 2 + 2?</p>
                                <div class="ms-4">
                                ...
                                <p class="text-success mt-2"><strong>Correct Answer:</strong> B</p>
                            </div>
                            <div class="mb-4 p-3" style="background: var(--bg-secondary); border-radius: 8px;">
                                <h5>Question 2</h5>
                                <p>Solve for x: 2x + 5 = 15</p>
                                <div class="ms-4">
                                    <p><strong>A)</strong> x = 5</p>
                                    <p><strong>B)</strong> x = 10</p>
                                    <p><strong>C)</strong> x = 7.5</p>
                                    <p><strong>D)</strong> x = 20</p>
                                </div>
                                <p class="text-success mt-2"><strong>Correct Answer:</strong> A</p>
                            </div>
                        </div>
                    </div>
                </div>
