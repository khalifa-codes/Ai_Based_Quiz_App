...
<body>
        ...
        <main class="admin-main">
            ...
            <div class="admin-topbar">
                <div class="topbar-left">
                    <div>
                        <h1 class="topbar-title">Add Student</h1>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="admin-form-group">
                                        ...
                                        <input type="text" class="admin-form-control" id="studentName" placeholder="Enter full name" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="admin-form-group">
                                        <label class="admin-form-label">Email <span class="text-danger">*</span></label>
                                        <input type="email" class="admin-form-control" id="studentEmail" placeholder="student@example.com" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="admin-form-group">
                                        <label class="admin-form-label">Phone Number</label>
                                        <input type="tel" class="admin-form-control" id="studentPhone" placeholder="+1234567890">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="admin-form-group">
                                        <label class="admin-form-label">Class <span class="text-danger">*</span></label>
                                        <select class="admin-form-control" id="studentClass" required>
                                ...
                                <div class="col-md-6">
                                    <div class="admin-form-group">
                                        ...
                                        <input type="text" class="admin-form-control" id="studentId" placeholder="Auto-generated if left empty">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="admin-form-group">
                                        <label class="admin-form-label">Status</label>
                                        <select class="admin-form-control" id="studentStatus">
    ...
    <script>
        document.getElementById('addStudentForm').addEventListener('submit', function(e) {
            ...
            alert('Student added successfully! (Backend integration pending)');
